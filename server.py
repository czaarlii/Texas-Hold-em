...
class Gra(Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            global_info += '\n' + str(
                stol.doloz_stawke(gracze[rozp], ustawienia.ciemne))  # początkowa stawka na 1. turę
                    ...
                    if gracze[aktywny].stan != poker.stan_gracza["va bank"]:  # wyjątek pomijający graczy vabank
                        ...
                        if aktywny == 0:
                            ...
                            conn.send(pickle.dumps(poker.PaczkaDoKlienta(stol=global_info,
                                                                         min=najwyzsza_stawka - stol.stawki_graczy[
                                                                             aktywny],
