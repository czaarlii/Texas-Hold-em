...
def zasadygry():
    ...
    print("Pierwszy gracz stawia tzw. mus, czyli stawkę 'w ciemno'.")
    ...
    print("Po słowie stawiam nie zapomnij powiedzieć kwoty! Możesz postawić od 10 do 1990zł, ale tylko wielokrotności liczby 10.")
